...
<div class="row justify-content-center">
        ...
        <main class="form-registration">
            ...
            <form action="/daftar" method="post">
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="agama" name="agama" required>
                            <option selected>Pilihan...</option>
                            ...
                            <option value="1"  @if (old('agama') == 'lain-lain') selected="selected" @endif>Lain - lain</option>
                        </select>
                    </div>
                    <input type="text" id="agama_text" name="agama_text" class="form-control @error('agama') is-invalid @enderror"
                    placeholder="Agama pasien" value="{{ old('agama_text') }}" style="display:none">
                </div>
                <div class="form-floating">
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="kode_provinsi" name="kode_provinsi" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="kode_kabupaten" name="kode_kabupaten" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="kode_kecamatan" name="kode_kecamatan" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="kode_kelurahan" name="kode_kelurahan" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="pendidikan" name="pendidikan" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="pekerjaan" name="pekerjaan" required>
                            <option selected>Pilihan...</option>
                ...
                <div class="form-floating">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select theSelect" id="status_pernikahan" name="status_pernikahan" required>
                            <option selected>Pilihan...</option>
    ...
    <script type="text/javascript">
        ...
        //     var x = document.getElementById("agama");
        //     var agama  = x.value;
        //     if (x = "lain-lain"){
        //         // $("#agama_text").style.display="block";
        //         document.getElementById("agama-text").style.display = "block"; 
        //     }
        // }
